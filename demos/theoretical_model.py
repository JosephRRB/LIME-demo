...
def deploy_plots_for_theoretical_model():
    ...
    - Generating a set of points called perturbations. For the tabular case, 
        these perturbations should mimic the training set. For text or images, 
        perturbations are generated by removing or retaining tokens or 
